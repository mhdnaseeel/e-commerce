...
const products = [
    {
        image: `${import.meta.env.VITE_BACK_END_URL}/images/iphone_adv.jpg`,
      ...
      {
        image: `${import.meta.env.VITE_BACK_END_URL}/images/samsung_adv.jpg`,
      ...
      {
        image: `${import.meta.env.VITE_BACK_END_URL}/images/pixel_adv.jpg`,
        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
           ...
           <div className="flex flex-col lg:flex-row justify-between items-center mb-12">
                ...
                <div className="w-full md:w-1/2 mb-6 md:mb-0">
                    <img
                        src={`${import.meta.env.VITE_BACK_END_URL}/images/about_team.jpg`}
                        alt="About Us"
